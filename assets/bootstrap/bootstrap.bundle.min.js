...
return e}function bc(a){var b=ac(a);return pb.reduce(function(c,d){return c.concat(b.filter(function(e){return e.phase===d}))},[])}function cc(a){var b;return function(){b||=new Promise(function(c){Promise.resolve().then(function(){b=void 0;c(a())})});return b}}function dc(a){var b=a.reduce(function(c,d){var e=c[d.name];c[d.name]=e?Object.assign({},e,d,{options:Object.assign({},e.options,d.options),data:Object.assign({},e.data,d.data)}):d;return c},{});return Object.keys(b).map(function(c){return b[c]})}
